            ...
            <br></br>
              <h3 className="text-2xl md:text-center fade-in-up md:py-2 md:text-3xl text-slate-300">
                <div className="text-teal-300">
                  <Typewriter
                    options={{
                      strings: ['High School Student', 'Bot Programmer', 'Web-App Developer', 'DECA State Qualifier', 'NHS Ambassador', 'YAG Treasurer', 'World Language Club Officer' ,'Jazz Band Guitarist', 'Club and HS Soccer Player'],
                      autoStart: true,
                      loop: true,
                    }}/>
                  </div>
