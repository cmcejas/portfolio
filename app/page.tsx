      ...
      <main className=" bg-gradient-to-b from-bgc1 to-bgc2 px-2 md:px-20 lg:px-40">
        ...
        <div className="flex justify-center fade-in-up text-slate-400 text-4xl pt-36 invisible lg:visible">
          ...
          <li className="md:invisible flex justify-center fade-in-up">
              <a className="bg-slate-700 text-xl text-white px-9 py-5 rounded-lg hover:transform hover:-translate-y-1 transition-transform duration-300 flex items-center space-x-2" href="Resume.pdf" download>
                <span>Resume</span>
