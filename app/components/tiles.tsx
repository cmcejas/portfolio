  ...
  return (
    <section id="two" className="pt-30 md:pt-0 lg:pt-0">
      ...
      <div className="gap-10 px-7 md:px-10 lg:flex-wrap lg:flex">
        <div
          className="w-[100%] 3ti:w-[30%] text-center p-10 rounded-xl my-10 hover:transform hover:-translate-y-2 transition-transform duration-300"
        ...
        >
          ...
          <p className="py-2 text-slate-300">College Student</p>
          <h4 className="hover:cursor-pointer underline py-3 text-teal-500">
        ...
        >
          ...
          <h4 className="py-2 text-teal-500">
        ...
        >
          ...
          <p className="pt-4 font-bold text-gray-400">
            Many projects on  <span className="underline"> <a href="https://github.com/cmcejas" target="_blank">github</a></span>.
          </p>
        </div>
        ...
        <div
          className="w-[100%] 3ti:w-[30%] text-center p-6 rounded-xl my-10 hover:transform hover:-translate-y-2 transition-transform duration-300"
          style={{ boxShadow: "0 0 20px rgba(200, 200, 200, 0.2)" }}
        >
          <Image
            src={guitar}
          ...
          />
          <h3 className="pb-2 text-lg font-medium text-white">Hobbies</h3>
          ...
          <p className="py-1 text-gray-400">
            School Clubs{" "}
            <span className="font-bold text-teal-500 cursor-pointer">
              <a href="#one">listed on resume </a>
            </span>
          </p>
        </div>
      </div>
